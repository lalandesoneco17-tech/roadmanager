...
<div style={{padding:'4px 12px',background:'#f8fafc',display:'flex',alignItems:'center',gap:8,flexWrap:'wrap',borderBottom:'1px solid '+C.border,fontSize:13}}>
