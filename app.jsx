...
let opTimeBuckets=[]; // [{startMin, endMin, opH, powerPct?, fuelL?, speedKmh?, fuelRateLh?}] tranches horaires LOCAL
const powerByHour={};const fuelByHour={};const speedByHour={};const fuelRateByHour={};
...
if(measText){
  ...
  // Enrichit chaque bucket avec power %, fuel L, vitesse km/h, conso L/h
