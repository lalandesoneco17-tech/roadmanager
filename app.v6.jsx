...
if(!data)return(<div style={{position:'fixed',inset:0,background:'#000',display:'flex',alignItems:'center',justifyContent:'center',zIndex:9998}}><img src="icone.png" alt="" style={{width:240,height:240,maxWidth:'62vw',maxHeight:'62vw',objectFit:'contain',animation:'rm-tourne 1.6s linear infinite'}}/></div>);
