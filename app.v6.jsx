...
const PLANNING_LAYOUT_DEFAULTS={zoom:100,cardGap:12,leftColW:95,cardRadius:10,cardBorder:3,empFont:15,machFont:13,chantierFont:15,locWidth:220,rowGap:5,rowPadV:6,chipFont:13};
...
return(
<div>
<h2 style={{marginBottom:4}}>📋 Recap heures — tous les chauffeurs <span style={{fontSize:10,color:C.dim,fontWeight:400,marginLeft:8}}>v2026.09.09-1</span></h2>
