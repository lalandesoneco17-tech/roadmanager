...
const tgSendAdmins=async(cfg,text,extra)=>{const tok=cfg&&cfg.telegramBotToken;if(!tok)return;for(const cid of tgAdminChats(cfg)){await tgSend(tok,cid,text,extra)}};
